	...
	<div class="main">
		...
		<div class="listOrder">
			<div class="order">
				...
				<form action='<c:url value ="/update-product"></c:url>' method="post" enctype="multipart/form-data">
					<table>
						<tr>
							<td>Mã sản phẩm</td>
							<td><input type="text" name="id" required="required" value="${product.id }"></td>
						</tr>
						...
						<tr>
							<td>Giá hiện tại</td>
							<td><input type="number" name="price" required="required" value="${product.basePrice}"></td>
						</tr>
						<tr>
							<td>Giá gốc</td>
							<td><input type="number" name="basePrice" required="required" value="${product.basePrice}"></td>
						</tr>
						...
						<tr>
							...
							<td class="radio-group">
								...
								<div>
									<input id="male" type = "radio" name ="male" value ="0" required="required">
						...
						<tr>
							...
							<td><input type="text" name="des"
								value=<c:out value="${product.desc}"/>></td>
						</tr>
					</table>
					<input type="hidden" value = "${product.id}" name =  "oldId">
					<div class="save-btn">
